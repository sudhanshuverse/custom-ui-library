...
class AHole extends HTMLElement {
    ...
    setLines() {
        ...
        this.linesCanvas = new OffscreenCanvas(width * this.render.dpi, height * this.render.dpi);
    ...
    initParticle(start = false) {
        ...
        return {
            ...
            p: 0,
            r,
            c: `rgba(255, 255, 255, ${0.8 + Math.random() * 0.2})`,
        };
    }
    /**
     * Tween value
    ...
    drawLines() {
        ...
        ctx.drawImage(linesCanvas, 0, 0, this.canvas.width, this.canvas.height);
    }
    /**
     * Draw particles
     */
